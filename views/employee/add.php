	...
	<div class="row">
		...
		<form class="form" action="?mod=employee&act=store" method="POST" role="form" enctype="multipart/form-data">
			<div class="text-center">
				<img style="border-radius: 50%; width: 200px; height:200px;" src="public/images/7a32562774204115412fabdd91fd34a6.jpg" class="avatar img-circle img-thumbnail" alt="avatar">
